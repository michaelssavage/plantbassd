...
Buy/ Stream here: <HoverLink url="nostrohoodsystem.bandcamp.com/album/delphinine-capriole-ep" inline external />

<Picture src="/fresh-juice/61-delphinine.jpg" alt="‘Delphinine Capriole album art" size={1200} />
<i className="smallText">Words by Oisín Campbell/ Design by Michael Savage</i>

<hr />

A producer, DJ and co-founder of the Turin based <HoverLink url="phobhorecords.bandcamp.com/" name="PHO BHO" inline external /> imprint, Confetti began mixing under his collective ‘Upstairs’, a Bergamo homeless based party which hosted artists and music not yet explored in the city. Furthermore he is one half of <HoverLink url="phobhorecords.bandcamp.com/album/wokatikitanku-ep" name="Ninja Exotic Machine" inline external /> alongside <HoverLink url="intersezioni.bandcamp.com/album/intrz005-acid-desert" name="Kakofonico" inline external />, exploring tribal rhythms immersed in tight electronic drum patterns and basslines.
...
<i className="smallText">(Pictured: Matteo Coffetti)</i>
...
Discover the extended <HoverLink url="nostrohoodsystem.bandcamp.com/" name="Nostro Hood System" inline external /> and <HoverLink url="bandcamp.com/search?q=matteo%2Bcoffetti&item_type" name="Matteo Coffetti" inline external /> collections.
