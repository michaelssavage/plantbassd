...
<BandCamp src="album=1132256846" />

Buy/ Stream here: <HoverLink url="homagenewyork.bandcamp.com/album/4ever" name="4EVER | RIOT CODE | HOMAGE" external />
...
<p className="smallText">(Pictured: Riot Code)</p>
...
Describing themselves as an independently run party series and label that focus on putting out ‘fucking bangers’, HOMAGE have hit yet another home run with RIOT CODE’s ‘4ever’.
...
RIOT CODE head to Edinburgh and Dundee next mid-week and finish their run of shows in Aberdeen, Glasgow, and Kirkcaldy which you can access here: <HoverLink url="ra.co/dj/riotcode/tour-dates" name="Tour Dates & Tickets - RIOT CODE" external />

Buy/ Stream the extended RIOT CODE catalogue here: <HoverLink url="riotcode.bandcamp.com/" name="Riot Code" external />

Buy/ Stream the extended HOMAGE catalogue here: <HoverLink url="homagenewyork.bandcamp.com/" name="HOMAGE" external />
