...
The initial 'Grimey Ones' effort (listen: <HoverLink url="oldboytrax.bandcamp.com/album/grimey-ones" external />) caught our attention last summer along with the ridiculous 128kpbs releases that the steel city based artist fronts with mates Phasmid, Xander, Papa Nugs, and Longeez, have firmly put Oldboy on our release radar.

<BandCamp src="album=732016776" />

Buy & Listen here: <HoverLink url="oldboytrax.bandcamp.com/album/grimey-ones-part-ii" external />
