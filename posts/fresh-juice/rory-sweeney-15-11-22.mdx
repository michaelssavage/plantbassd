...
Buy/ Stream here: <HoverLink url="rory2.bandcamp.com/album/trash-catalogue-pt-1" external inline />

<Picture
  src="/fresh-juice/51-rory-sweeney.jpg"
  alt="Trash Catalogue Part 1 album art"
  size={1200}
/>
...
<Picture src="/news/10-sweeney.jpg" alt="Rory Sweeney cover pic" size={1200} />
<p className="smallText text-center">(Pictured: Rory Sweeney)</p>
...
(see video directed by Grainne Calvin here: <HoverLink url="www.youtube.com/watch?v=8FIDcmW7Ejc" external inline />)
...
(Accompanied by Cian Redmond's sharply directed video - see here: <HoverLink url="www.youtube.com/watch?v=QSDejYMKeDE" external inline />)
...
<Picture src="/fresh-juice/51-emby.jpg" alt="Rory Sweeney & EMBY pic" size={1200} />
<p className="smallText text-center">(Pictured: Rory Sweeney & EMBY)</p>
...
Discover the entire Rory Sweeney collection here: <HoverLink url="rory2.bandcamp.com/album/trash-catalogue-pt-1" external inline />
