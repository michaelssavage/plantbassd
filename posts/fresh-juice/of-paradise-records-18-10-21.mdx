...
The compilation is available for purchase now on Bandcamp. Some fantastic tools on this one: <HoverLink url="ofparadise.bandcamp.com/album/of-paradise-vol-4" external />
...
<HoverLink url="www.instagram.com/eggboy_design" name="@eggboy_design" external /> on graphics.
