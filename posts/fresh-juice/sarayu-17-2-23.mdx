...
Buy/ Stream here: <HoverLink url="boiledwonderland.bandcamp.com/album/intelligent-jump-rope-music-w-locked-groove-remix"  name="Intelligent Jump Rope Music (w/ Locked Groove Remix) | Sarayu | Boiled Wonderland Records" inline external />

<Picture
  src="/fresh-juice/60-wonderland.png"
  alt="Intelligent Jump Rope Music album art"
  size={1200}
/>
...
After establishing his tracks on his own <HoverLink url="morerice.bandcamp.com/" name="More Rice" inline external /> imprint as well as providing to <HoverLink url="fufurecords.com/" name="FuFu Records" inline external /> over the last two years, Sarayu’s next venture in sound takes a deeper, darker focused club view with the 4 track ‘Intelligent Jump Rope Music’, teaming up with the essential Locked Groove who jumps in on remix duties.
...
<i className="smallText">(Pictured: Sarayu)</i>
...
Discover the extended <HoverLink url="boiledwonderland.bandcamp.com/" name="Boiled Wonderland" inline external /> catalogue as well as Sarayu’s own <HoverLink url="morerice.bandcamp.com/" name="More Rice" inline external />.
