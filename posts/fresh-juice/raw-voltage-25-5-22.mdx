...
Buy/ Stream here <HoverLink url="ovelhatrax.bandcamp.com/album/va-raw-voltage" external inline />
...
<Picture src="/fresh-juice/35-ovelha.jpg" alt="ovelha cover pic" width="65%" />
...
Raw Voltage V/A is available to buy and stream now, and in true Ovelha Trax fashion, they have already landed another release this month with Bicycle Ride's 'Distorted Wheels' (see here: <HoverLink url="ovelhatrax.bandcamp.com/album/bicycle-ride-distorted-wheels-3" external inline /> ).

Discover the extended Ovelha Trax catalogue here: <HoverLink url="ovelhatrax.bandcamp.com/" external inline />
