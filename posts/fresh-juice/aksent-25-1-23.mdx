...
Buy/ Stream here: <HoverLink url="aksentire.bandcamp.com/track/slaves" inline external />

Watch the full video here: <HoverLink url="https://www.youtube.com/watch?v=L_8nLYn-fiM" inline external />

<Picture src="/fresh-juice/54-cover.jpg" alt="aksent music video" size={1200} />
...
<p className="smallText">
  <i>(Pictured: AKSENT in director mode)</i>
</p>
...
<p className="smallText">
  <i>(Pictured: Cian Fitzsimons on set)</i>
</p>
...
<p className="smallText">
  <i>(Pictured L-R: 'Dilla' Dillon McMahon, Cian Fitzsimons, & Dan Whelan on set)</i>
</p>
...
Discover his extended discography here: <HoverLink url="aksentire.bandcamp.com/" inline external />
