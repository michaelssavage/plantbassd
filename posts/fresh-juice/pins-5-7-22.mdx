...
bio: "With PINS comes a short aural trip into Glasgow's creative underbelly, compiling some of the city's most talented and experimental focused electronic artists."
path: fresh-juice
---
...
<BandCamp src="album=4210413025" />

Buy/ Stream here: <HoverLink url="pinsglasgow.bandcamp.com/album/pins-a-compilation-of-electronic-music-from-glasgow" external inline />
...
<Picture src="/fresh-juice/44-cover.jpg" alt="pins cover pic" size={1200} />
...
<Picture src="/fresh-juice/44-pins.jpg" alt="pins 2nd cover pic" size={1200} />
...
Both digital and physical formats are available now on Bandcamp: <HoverLink url="pinsglasgow.bandcamp.com/album/pins-a-compilation-of-electronic-music-from-glasgow" external inline />
