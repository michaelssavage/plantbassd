...
(Buy/ Listen here) <HoverLink url="raiders.bandcamp.com/album/viikatory-based-on-your-listening-history" external inline />

<Picture src="/fresh-juice/29_Viikatory.png" alt="BOYLH album art" size={1200} />
...
<Picture src="/fresh-juice/29_cover.png" alt="Viikatory cover pic" size={1200} />
...
Discover the extended Viikatory catalogue here: <HoverLink url="viikatory.bandcamp.com" external inline />

Discover the extended Raiders catalogue here: <HoverLink url="raiders.bandcamp.com/" external inline />
