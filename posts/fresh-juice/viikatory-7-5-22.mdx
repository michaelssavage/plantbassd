...
(Buy/ Listen here) <HoverLink url="raiders.bandcamp.com/album/viikatory-based-on-your-listening-history" external />
...
Discover the extended Viikatory catalogue here: <HoverLink url="viikatory.bandcamp.com" external />

Discover the extended Raiders catalogue here: <HoverLink url="raiders.bandcamp.com/" external />
