...
Buy/ stream here: <HoverLink url="philthtrax.bandcamp.com/album/drop-the-bass" external inline />

<Picture src="/fresh-juice/34-generator.jpg" alt="generator album art" size={1200} />
...
<Picture src="/fresh-juice/34-cover.png" alt="philthtrax cover pic" size={1200} />
...
Another cracker from the Toronto-based label. You can catch up with our recent interview with label boss Cherriep here, <HoverLink url="www.plantbassd.com/fresh-juice/plot-twist-17-2-22" external inline />, chatting all things Philthtrax, and the do's and don'ts of our infamous industry!

Discover the extended Philthtrax catalogue here: <HoverLink url="philthtrax.bandcamp.com/" external inline />
