...
Last Friday’s Hooverian Blur release (<HoverLink url="https://wnclrecordings.bandcamp.com/album/wncl043" name="see here" inline external />) marked the 43rd full feature on the catalogue that has also produced a number of free download tracks and sample kits. Bob’s brainchild now stands as one of the leading labels in UK rave. Does it surprise him?
...
<ReactPlayer url="/news/38-bob-bhamra.mp4" width="100%" height="500px" loop muted playing />

<p className="smallText text-center">(Bob Bhamra DJing)</p>
...
Discover the extender WNCL catalogue here: <HoverLink url="https://wnclrecordings.bandcamp.com/" inline external />
