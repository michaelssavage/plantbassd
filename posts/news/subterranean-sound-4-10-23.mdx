...
<Picture src="/news/48-grdn.png" alt="GRDN collective" size={1200} />
(Pictured: the GRDN collective performing at Subterranean Sound 2022).
...
<Picture src="/news/48-lws.png" alt="LWS" size={1200} />
(Pictured: LWS)
