...
<Picture src="/news/17-session-victim.jpg" alt="Session Victim" size={1200} />
...
22.30 - 23.30  
Session Victim were one of our 'must-see' acts. Their chemistry together was magnetic and our expectations for a succinct mix were met. At this stage of the night, multiple acts were starting to perform at the same time but we had to stay for the funky bass riffs from Matthias Reiling. Check out <HoverLink url="open.spotify.com/track/1MLEgLIn8xJelIAAJTcmgc" external inline />.
...
<Picture src="/news/17-the-dock.jpg" alt="The Dock" size={1200} />
<div className="text-center">(Pictured: The Dock, image from anotherlovestory.ie)</div>
...
<Picture src="/news/17-robocobra.jpg" alt="Robocobra Quartet" size={1200} />
<div className="text-center">
...
<Picture src="/news/17-food-vendors.png" alt="Food Vendors" size={1200} />
<div className="text-center">(Pictured: Another Love Story food vendors)</div>
