...
<div className="imgContainer">
  <a href="https://www.youtube.com/watch?v=QnvxRT9nUbc" rel="noopener noreferrer" target="_blank">
    <Picture src="/news/05_loraine-james.jpg" alt="loraine james press photo" size={1200} />
...
<div className="imgContainer">
  <a
    ...
    target="_blank"
  >
    <Picture src="/news/05_kink.jpg" alt="photo of KiNk" size={1200} />
    <div className="youtubeOverlay">
      <div className="imgTextOverlay">Listen On Youtube</div>
    </div>
  </a>
...
<div className="imgContainer">
  <a href="https://www.youtube.com/watch?v=53SR5UNOpAI" rel="noopener noreferrer" target="_blank">
    <Picture src="/news/05_giant-swan.jpg" alt="photo of Giant Swan" size={1200} />
    <div className="youtubeOverlay">
      <div className="imgTextOverlay">Listen On Youtube</div>
    </div>
  </a>
