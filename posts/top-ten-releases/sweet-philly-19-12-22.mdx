...
Buy & Listen here: <HoverLink url="psychichotline.bandcamp.com/album/inertia" name="BandCamp" external inline />
...
Listen here: <HoverLink url="open.spotify.com/track/3fuyYaLhZ2RoP9eWpvfP1H" name="Spotify" external inline />
...
Buy & Listen here: <HoverLink url="jockstrapmusic.bandcamp.com/track/concrete-over-water" name="BandCamp" external inline />
...
Buy & Listen here: <HoverLink url="twoshell.bandcamp.com/album/home-3" name="BandCamp" external inline />
...
Buy & Listen here: <HoverLink url="ad93.bandcamp.com/album/060" name="BandCamp" external inline />
...
<div className="row display-flex align-items-center">
<div className="col clubGuide">
<Picture src="/fresh-juice/46-palidrone.jpg" alt="J Wax - Limes" size={1200} />
</div>
<div className="col clubGuide">
...
Buy & Listen here: <HoverLink url="palidrone.bandcamp.com/album/rattle" name="BandCamp" external inline />
...
Buy & Listen here: <HoverLink url="ossx.bandcamp.com/album/turnpike-authority-ii-2" name="BandCamp" external inline />
...
Buy & Listen here: <HoverLink url="clairerousay.bandcamp.com/album/everything-perfect-is-already-here" name="BandCamp" external inline />
...
Buy & Listen here: <HoverLink url="himera.bandcamp.com/album/sharing-secrets-unsl020" name="BandCamp" external inline />
