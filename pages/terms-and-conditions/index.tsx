...
export default function PrivacyPolicy() {
  return (
    <div className="aboutBG">
      ...
      <h1 className={styles.pageHeader}>Terms and Conditions</h1>

      <p>Welcome to Plant Bass'd!</p>
      ...
      <p>
        By accessing this website it is assumed that you accept the terms and conditions. Do not
        continue to use Plant Bass'd if you do not agree with the terms and conditions stated on
        this page.
      </p>
      ...
      <p>
        ...
        using this website whom is compliant to the Company's terms and conditions. "The Company",
      ...
      <p>
        We do not employ the use of cookies. Cookies are used by websites to enable the
      ...
      <p>
        Unless otherwise stated, Plant Bass'd and/or its licensors own the intellectual property
        rights for all material on Plant Bass'd. All intellectual property rights are reserved. You
        may access this from Plant Bass'd for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Plant Bass'd</li>
        <li>Sell, rent or sub-license material from Plant Bass'd</li>
        <li>Reproduce, duplicate or copy material from Plant Bass'd</li>
        <li>Redistribute content from Plant Bass'd</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for reviewees to share their opinions and in blog
        posts in parts of the website. Comments do not reflect the views and opinions of Plant
        Bass'd, its agents and/or affiliates. Comments reflect the views and opinions of the person
        who share their views and opinions. To the extent permitted by applicable laws, Plant Bass'd
        shall not be liable for the views or for any liability, damages or expenses caused and/or
        suffered as a result of any use of and/or posting of and/or appearance of the comments on
        this website. Users are not able to share comments on the site.
      </p>

      <p>
        You hereby grant Plant Bass'd a non-exclusive license to use, reproduce, edit and authorize
      ...
      <p>
        ...
        visibility of the hyperlink compensates the absence of Plant Bass'd; and (d) the link is in
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an email to Plant Bass'd. Please
      ...
      <p>
        No use of Plant Bass'd's logo or other artwork will be allowed for linking absent a
