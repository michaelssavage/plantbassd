    ...
    <>
      ...
      <div className="aboutBG">
        ...
        <p>
          ...
          rights for all material on Plant Bass'd. All intellectual property rights are reserved.
          You may access this from Plant Bass'd for your own personal use subjected to restrictions
        ...
        <p>
          Parts of this website offer an opportunity for reviewees to share their opinions and in
          blog posts in parts of the website. Comments do not reflect the views and opinions of
          Plant Bass'd, its agents and/or affiliates. Comments reflect the views and opinions of the
          person who share their views and opinions. To the extent permitted by applicable laws,
          Plant Bass'd shall not be liable for the views or for any liability, damages or expenses
          caused and/or suffered as a result of any use of and/or posting of and/or appearance of
          the comments on this website. Users are not able to share comments on the site.
        </p>

        <p>
          You hereby grant Plant Bass'd a non-exclusive license to use, reproduce, edit and
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of Plant Bass'd; and (d) the link is
