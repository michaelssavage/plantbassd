    ...
    <>
      ...
      <div className="aboutBG">
        ...
        <p>
          ...
          is collected and recorded by <b>Plant Bass'd</b> and how we use it.
        </p>
        <p>
          This Privacy Policy applies only to our online activities and is valid for visitors to our
          website with regards to the information that they shared and/or collect in{" "}
          <b>Plant Bass'd</b>. This policy is not applicable to any information collected offline or
        ...
        <p>
          When you sign up to our newsletter, we will receive information about your name and email
          address. You can remove yourself from the newsletter at any time.
        </p>
        ...
        <p>
          <b>Plant Bass'd</b> follows a standard procedure of using log files. These files log
        ...
        <p>
          ...
          Beacons that are used in their respective advertisements and links which are sent directly
          to users' browser. Note that <b>Plant Bass'd</b> does not use any third-party ad servers.
        </p>

        <h2>Third Party Privacy Policies</h2>

        <p>
          <b>Plant Bass'd</b>'s Privacy Policy does not apply to other advertisers or websites.
          Thus, we are advising you to consult the respective Privacy Policies of any future
        ...
        <p>
          <b>Plant Bass'd</b> does not knowingly collect any Personal Identifiable Information from
