...
export default function PrivacyPolicy() {
  return (
    <div className="aboutBG">
      ...
      <p>
        <b>Plant Bass'd</b>'s Privacy Policy does not apply to other advertisers or websites. Thus,
        we are advising you to consult the respective Privacy Policies of any future third-party ad
