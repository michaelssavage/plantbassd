...
Buy/ Stream here: <HoverLink url="rory2.bandcamp.com/album/carlos-dangers-summer-sound" external />
...
<HoverLink url="www.instagram.com/eggboy_design" name="@eggboy_design" external /> on the graphics as
per.
