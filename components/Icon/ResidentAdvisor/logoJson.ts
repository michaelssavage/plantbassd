...
export const logoJson = {
  ...
  child: [
    ...
    },
    {
      tag: "path",
      attr: {
        d: "M228 10.5c0 3 .5 5.5 1 5.5.6 0 1-1.2 1-2.6 0-3.2 3-3 4.5.4 1.7 3.9 3.2 2.7 1.6-1.3-.5-1.1-.4-2.5.1-3.3 1.6-1.9-1-4.2-4.8-4.2H228v5.5zm6.5-2c0 .5-1 1.1-2.2 1.3-1.6.2-2.3-.2-2.3-1.3s.7-1.5 2.3-1.3c1.2.2 2.2.7 2.2 1.3z",
      },
      child: [],
    },
  ],
